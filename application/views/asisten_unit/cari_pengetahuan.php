				...
				<div class="portlet-body">
					...
					<div class="row">
						<div class="col-md-8 blog-article">
							<h3>
							<a href="<?= base_url('asisten-unit/detail-pengetahuan-tacit/' . $row->id_tacit) ?>">
							<?= $row->judul ?></a>
							</h3>
							...
							<a class="btn blue btn-xs" href="<?= base_url('asisten-unit/detail-pengetahuan-tacit/' . $row->id_tacit) ?>">
					...
					<div class="row">
						<div class="col-md-8 blog-article">
							<h3>
							<a href="<?= base_url('asisten-unit/detail-pengetahuan-eksplisit/' . $row->id_eksplisit) ?>">
							<?= $row->judul ?></a>
							</h3>
							<ul class="list-inline">
								<li>
							...
							<a class="btn blue btn-xs" href="<?= base_url('asisten-unit/detail-pengetahuan-eksplisit/' . $row->id_eksplisit) ?>">
							Selengkapnya <i class="m-icon-swapright m-icon-white"></i>
							</a>
						</div>
					</div>
...
<script type="text/javascript">
	function set_like_tacit(id_tacit, obj) {
		...
		$.ajax({
			url: '<?= base_url('asisten-unit/share-tacit') ?>',
			type: 'POST',
			data: {
				like: true,
				id_tacit: id_tacit
	...
	function set_like_eksplisit(id_eksplisit, obj) {
		let current_likes = $(obj).prev().prev().val();
		$.ajax({
			url: '<?= base_url('asisten-unit/share-eksplisit') ?>',
			type: 'POST',
			data: {
				like: true,
