            ...
            <div class="jumbotron">
                <div class="container">
                    <center>
                        ...
                        <br><br>
                        <?= form_open('asisten-unit/cari-pengetahuan', ['class' => 'form-horizontal']) ?>
            ...
            <a href="<?= base_url('asisten-unit/pengetahuan-tacit')?>">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="dashboard-stat red">
                        ...
                        <a class="more" href="<?= base_url('asisten-unit/pengetahuan-tacit')?>">
            ...
            <a href="<?= base_url('asisten-unit/pengetahuan-eksplisit')?>">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="dashboard-stat green">
                        ...
                        <a class="more" href="<?= base_url('asisten-unit/pengetahuan-eksplisit')?>">
                            View more <i class="m-icon-swapright m-icon-white"></i>
                        </a>
                    </div>
                </div>
