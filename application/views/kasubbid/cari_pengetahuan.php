				...
				<div class="portlet-body">
					...
					<div class="row">
						<div class="col-md-8 blog-article">
							<h3>
							<a href="<?= base_url('kasubbid/detail-pengetahuan-tacit/' . $row->id_tacit) ?>">
							<?= $row->judul ?></a>
							</h3>
							...
							<a class="btn blue btn-xs" href="<?= base_url('kasubbid/detail-pengetahuan-tacit/' . $row->id_tacit) ?>">
...
<script type="text/javascript">
	function set_like_tacit(id_tacit, obj) {
		...
		$.ajax({
			url: '<?= base_url('kasubbid/share-tacit') ?>',
			type: 'POST',
			data: {
				like: true,
				id_tacit: id_tacit
