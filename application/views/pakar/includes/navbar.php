                                    ...
                                    <?php foreach ($notifikasi as $row): ?>
                                        <?php  
                                            if ($row->jenis == 'Tacit' or $row->jenis == 'Tag Tacit')
                                            {
                                                ...
                                                $link = base_url('pakar/detail-pengetahuan-tacit/' . $row->id_pengetahuan);
                                            ...
                                            else
                                            {
                                                ...
                                                $link = base_url('pakar/detail-pengetahuan-eksplisit/' . $row->id_pengetahuan);
